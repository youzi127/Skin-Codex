...
5. 要在自己的 Codex 中安装该 Skill，可运行：`python C:\Users\Administrator\.codex\skills\.system\skill-installer\scripts\install-skill-from-github.py --repo yuqi379/Skin-Codex --path skills/skin-codex-theme-dev`。安装后开启新的 Codex 任务，即可用 `$skin-codex-theme-dev` 调用它。
